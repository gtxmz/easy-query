...
public interface OverrideEntityQueryable4<T1Proxy extends ProxyEntity<T1Proxy, T1>, T1,
    ...
    @Override
    default EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> where(SQLActionExpression1<T1Proxy> whereExpression) {
        return where(true, whereExpression);
    }

    @Override
    EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> where(boolean condition, SQLActionExpression1<T1Proxy> whereExpression);

    @Override
    default EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> having(SQLActionExpression1<T1Proxy> predicateExpression) {
        return having(true, predicateExpression);
    }

    @Override
    EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> having(boolean condition, SQLActionExpression1<T1Proxy> predicateExpression);

    @Override
    default EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> orderBy(SQLActionExpression1<T1Proxy> selectExpression) {
        return orderBy(true, selectExpression);
    }

    @Override
    EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> orderBy(boolean condition, SQLActionExpression1<T1Proxy> selectExpression);
    ...
    @Override
    EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> asTableSegment(BiFunction<String, String, String> segmentAs);
    ...
    @Override
    EntityQueryable4<T1Proxy, T1, T2Proxy, T2, T3Proxy, T3, T4Proxy, T4> configure(SQLActionExpression1<ContextConfigurer> configurer);

    @Override
    default EntityQueryable4<AggregateQueryable<T1Proxy, T1>, T1,
            AggregateQueryable<T2Proxy, T2>, T2,
            AggregateQueryable<T3Proxy, T3>, T3,
            AggregateQueryable<T4Proxy, T4>, T4> groupBy() {
        return new EasyEntityQueryable4<>(
                ...
                , this.getQueryable4().getClientQueryable4()
        );
    }
}
